...
var sourcedRepoCouch = require('../index');
var Repository = sourcedRepoCouch.Repository;
...
describe('Repository', function () {
  ...
  it.skip('should load deserialized market entity from snapshot, digest two events, and update version, snapshotVersion, and price', function (done) {
  ...
  it.skip('should emit all enqueued eventsToEmit after only after committing', function (done) {
  ...
  it.skip('should load multiple deserialized market entities from snapshot, and commit in bulk', function (done) {
  ...
  it.skip('should load all entities when getAll called with callback only', function (done) {
  ...
  it.skip('should take snapshot when forceSnapshot provided', function (done) {
  ...
  it.skip('should return null when get called with id of nonexisting entity', function (done) {
  ...
  it.skip('should return null when getAll called with only ids of nonexisting entities', function (done) {
